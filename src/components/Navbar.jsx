...
const navLinks = [
  { name: 'Home', href: '#home' },
  {
    name: 'About Us',
    href: '#about',
    dropdown: ['Our Vision', 'Our Mission', 'Management', 'History']
  },
  {
    name: 'Academics',
    href: '#programs',
    dropdown: ['Primary Wing', 'Middle School', 'Senior Secondary', 'Curriculum']
  },
  ...
  { name: 'Infrastructure', href: '#campus' },
  {
    name: 'Admission',
    href: '#admission',
    dropdown: ['Process', 'Fee Structure', 'Apply Online']
  },
              ...
              <div className="px-4 py-4 space-y-1">
                {navLinks.map((link) => (
                  <a
                    ...
                    className="block px-4 py-3 rounded-lg text-primary/80 hover:text-accent hover:bg-accent/5 transition-all font-outfit font-medium"
                  >
                    {link.name}
                  </a>
                ))}
