...
import { FiAward, FiBookOpen, FiGlobe, FiBriefcase } from 'react-icons/fi'

const features = [
  {
    icon: <FiBookOpen className="text-2xl" />,
    title: 'Academic Rigor',
    desc: 'Intensive preparation for board examinations and higher education.'
  },
  {
    icon: <FiAward className="text-2xl" />,
    title: 'Excellence in Action',
    desc: 'Fostering a culture of excellence in both academics and extracurricular pursuits.'
  },
  {
    icon: <FiGlobe className="text-2xl" />,
    title: 'Global Perspective',
    desc: 'Preparing students for global opportunities through comprehensive curricula.'
  },
  {
    icon: <FiBriefcase className="text-2xl" />,
    title: 'Career Readiness',
    desc: 'Equipping students with skills and guidance for their future professional journeys.'
  },
]
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-6 relative">
        ...
        >
          ...
          <h2 className="text-3xl lg:text-5xl font-playfair font-bold text-primary leading-tight">
            Senior <span className="text-gradient">Secondary</span>
          </h2>
          <p className="mt-6 text-primary/60 text-lg leading-relaxed font-inter">
            Our Senior Secondary program prepares students for the challenges of higher education and beyond. 
            We offer diverse streams and personalized guidance to help them achieve their academic and career goals.
          </p>
        </motion.div>
        ...
        >
          <div className="animated-gradient p-12 lg:p-16 text-center">
            <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=1200&q=60')] bg-cover bg-center opacity-10" />
            <div className="relative z-10">
              ...
              >
                <FiAward className="text-gold text-3xl" />
              </motion.div>
              <blockquote className="text-white text-2xl lg:text-3xl font-playfair font-bold italic leading-relaxed max-w-4xl mx-auto">
                "Shaping leaders of tomorrow through rigorous academics, profound values, and limitless vision."
              </blockquote>
